...
class AtmosphericEffects {
  ...
  detectPerformanceTier() {
    // Check for reduced motion preference - always low tier
  ...
  setupEventListeners() {
    ...
    // Role transitions - clear all effects
  ...
  createAftermath() {
    ...
    const particleCount = this.performanceTier === 'low' ? 4 : 
                          this.performanceTier === 'medium' ? 6 : 8;
  ...
  createAsh() {
    ...
    // Reduce particle count on low-end devices
    const particleCount = this.performanceTier === 'low' ? 5 : 
                          this.performanceTier === 'medium' ? 7 : 10;
