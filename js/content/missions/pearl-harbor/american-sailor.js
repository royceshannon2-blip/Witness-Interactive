 ...
 * - 1,177 of 1,512 crew members killed ΓÇö 77.8% fatality rate
...
const americanSailorScenes = [
  {
    id: "as-scene-01",
    narrative: `Sunday morning, 0745 hours. The mess deck smells like coffee and pancakes. Around you, sailors in dungarees joke about shore leave, complain about the heat, argue about last night's boxing match. Through the porthole, you can see the other battleships of Battleship RowΓÇöCalifornia, Maryland, Oklahoma, Tennessee, West Virginia, Nevada. Eight battleships lined up like steel dominoes.

You're scheduled for the 0800 watch, but you're early. Some of the crew are still ashoreΓÇöSaturday night liberty in Honolulu. The ship feels quiet, peaceful. A few men are topside preparing for the morning colors ceremony. The band is setting up on the fantail of the Nevada.
...
Your buddy nudges you, points at the sky. "Aircraft. Lot of 'em." You squint into the morning sun. Planes, dozens of them, coming in low from the north. Training exercise? Nobody mentioned a drill. Then you see the red circles on the wings.`,
  ...
  {
    id: "as-scene-02",
    narrative: `0755 hours. The first explosions rip across Ford Island. Torpedo bombers scream past at mast height, so close you can see the pilots' faces. A massive geyser erupts beside the OklahomaΓÇötorpedo hit. The ship shudders, begins listing immediately.

The general alarm finally wails. Men pour from below decks, some half-dressed, some still in skivvies. Officers shout orders. The anti-aircraft guns are unmanned, locked, ammunition stored below. You hear the rattle of small arms fireΓÇösailors shooting rifles at aircraft moving three hundred miles per hour.

A torpedo bomber roars past Arizona's bow, missing by yards. You're moored outboard of the repair ship VestalΓÇöthe torpedo can't reach you directly. But dive bombers are circling overhead now, and you can hear the whistle of falling bombs. The water around Battleship Row churns with explosions, oil, debris, and men.`,
    apThemes: ["perspective", "causation"],
    apKeyConcept: "KC-7.3.I",
  ...
  {
    id: "as-scene-03",
    narrative: `0806 hours. You're on the main deck when you hear itΓÇöa sound like tearing metal, impossibly loud. A bomb has punched through the forward deck near Turret II. For one frozen second, nothing happens.

Then the world ends.

The forward magazine detonates. One hundred eighty thousand gallons of aviation fuel, five hundred tons of gunpowder, over a million pounds of munitionsΓÇöall igniting at once. The explosion lifts the thirty-three-thousand-ton battleship out of the water. A fireball fifty feet high erupts from the forward section, consuming everything. The blast wave throws you across the deck.

Your ears ring. You can't hear anything. Smoke, fire, chaos. The forward part of the ship is simply goneΓÇötwisted metal, flames, bodies. Men are jumping overboard into water that's already burning with oil. The ship is listing, settling fast. You have maybe minutes.`,
  ...
  {
    id: "as-scene-04",
    narrative: `0820 hours. Arizona is settling fast, her superstructure wreathed in fire. The oil on the harbor surface is burningΓÇöthick black smoke, orange flame, men screaming in the water. You've made it this far. But the water around the ship is a death trap of burning fuel.

Across the harbor, other ships are fighting back now. The Nevada is actually movingΓÇömaking a run for the channel, the only battleship to get underway. AA guns on every ship are firing. But it's chaosΓÇöno coordination, no clear command structure. Every officer who knew the battle plan is dead or missing.
...
A launch from Ford Island is pulling men from the water, but it's overwhelmed. You see a group of men trapped on Arizona's fantail, cut off from the water by fire. You also see a line of men swimming toward you from a different direction, exhausted, going under.`,
  ...
  {
    id: "as-scene-05",
    narrative: `0945 hours. The attack is over. The Japanese planes are gone, heading back to their carriers. The silence is worse than the noiseΓÇöjust the crackle of fires, the hiss of steam, the cries of wounded men.

Arizona has settled on the harbor bottom, her superstructure still visible above water. Eleven hundred and seventy-seven of your shipmates are gone. Some died in the initial explosion. Some drowned below decks. Some burned in the oil fires. You think about the men you knewΓÇöthe kid from Iowa who played harmonica, the chief who taught you knots, the officer who always had a kind word.

Across the harbor, rescue efforts continue. Oklahoma's hull is being cut open to free trapped sailors. Salvage crews are already planning how to raise the sunken ships. But ArizonaΓÇöArizona is too far gone. She'll stay here, a tomb for the men who couldn't escape.

You stand on Ford Island, covered in oil and ash, watching your ship burn. You think about this morningΓÇöthe coffee, the pancakes, the jokes about shore leave. You think about how everything changed in two hours. You think about what happens next.`,
...
const americanSailorOutcomes = [
...

  {
    ...
    deathContext: {
      ...
      yourChoices: "You went below to secure the magazines ΓÇö the exact location of the catastrophic explosion. When the armor-piercing bomb detonated 500 tons of gunpowder, there was no escape from below decks."
    },
    epilogue: `You do not survive the attack on Pearl Harbor.

You were below deck when it happened. Doing your duty ΓÇö trying to secure the magazines, protect the ship, follow your training. The armor-piercing bomb punched through the forward deck and into the magazine at 0806 hours. Five hundred tons of gunpowder. One hundred eighty thousand gallons of aviation fuel. All of it at once.

The explosion lifted a 33,000-ton battleship out of the water. Below deck, there was no warning, no time, nothing.

You are one of 1,177 sailors who died aboard USS Arizona on December 7, 1941. Your body will never be recovered ΓÇö the ship rests on the harbor bottom, a tomb for you and 1,176 others. In 1962, a memorial will be built above the wreck. Your name will be engraved on the marble wall. Millions of visitors will stand above you and read it.
...
You could have jumped immediately. You could have been in the water, swimming for Ford Island, before the ship began to sink. Instead you helped others ΓÇö pulled men from the deck, kept the path to the side clear, made sure others went first.
...
You are one of 1,177 sailors on the Arizona memorial wall. But among those who survived, your name will be spoken differently ΓÇö as someone who had the chance to live and chose not to take it alone.
...
That choice cost you your life. It gave others theirs.`
...

  {
    ...
    deathContext: {
      ...
      historicalRate: "1,177 of 1,512 USS Arizona crew members died ΓÇö a 77.8% fatality rate, the highest of any U.S. warship in history.",
      yourChoices: "You were aboard USS Arizona on December 7, 1941. The odds were never in your favor."
    },
    epilogue: `You do not survive the attack on Pearl Harbor.

One thousand one hundred and seventy-seven sailors died on USS Arizona on December 7, 1941. You are one of them. The greatest loss ever suffered by a single U.S. Navy ship. The ship that has become the symbol of that day ΓÇö still on the harbor bottom, still leaking oil more than eighty years later, what sailors call "the tears of the Arizona."
...
But the memories stay with you. The explosion. The fires. The faces of men you couldn't save. You'll serve throughout the war ΓÇö in the Coral Sea, at Midway, in the Philippine Sea. You'll see more combat, more death, more ships sinking. But nothing will ever match the shock of that Sunday morning.

After the war, you'll return to Pearl Harbor once. You'll stand at the Arizona Memorial, looking down at the rusted hull beneath the water, and you'll remember the 1,177 men who never left. You'll remember that you survived because you kept moving, kept helping, refused to stop. And you'll carry that weight ΓÇö the weight of the ones you couldn't reach ΓÇö for the rest of your life.`
  },
...
You'll never forget December 7, 1941. The surprise. The fury. The helplessness of watching your ship die. But you'll also remember that America didn't quit. That sailors like you stood and fought even when everything seemed lost. That from the wreckage of Pearl Harbor came the determination that won a war.`
...

  {
    ...
    epilogue: `You survive the attack on Pearl Harbor. When the magazine exploded and Arizona began to sink, you made the hardest choice a sailor can make ΓÇö you got off the ship. You jumped into burning water, swam through oil and debris, fought to stay alive. Some will call it instinct. You know it was survival.
...
After the war, you'll learn that survival isn't something to apologize for. That living through Pearl Harbor gave you the chance to fight in the battles that followed. That the men who died on Arizona would have wanted you to live, to remember them, to tell their story. You'll spend the rest of your life making sure the world never forgets what happened that Sunday morning. That's your duty now.`
...

  {
    ...
    survived: true,
    conditions: {},
    epilogue: `You survive the attack on Pearl Harbor. In the chaos of that morning ΓÇö the explosions, the fires, the dying ship ΓÇö you did what you could. You followed your instincts, helped where you were able, and somehow made it through when 1,177 of your shipmates didn't.
...
But you'll never forget Arizona. The ship that was your home. The men who were your family. The morning that changed everything. December 7, 1941 ΓÇö a date that will live in infamy. You were there. You survived. And you'll carry the memory of that day, and the men who didn't survive, for the rest of your life.`
  }
];
