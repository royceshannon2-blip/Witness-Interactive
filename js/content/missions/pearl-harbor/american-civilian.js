 ...
 * - 32 civilians killed in Honolulu alone ΓÇö most from friendly fire
...
const americanCivilianScenes = [
  {
    id: "ac-scene-01",
    narrative: `Sunday morning, 0745 hours. The smell of coffee drifts from the kitchen. Your small house sits in a neighborhood between Pearl Harbor and HonoluluΓÇöclose enough to hear the morning bugle calls from the naval base, far enough to feel like home. Through the window, you can see neighbors tending gardens, children playing in yards, the peaceful rhythm of a Sunday morning.

You work as a civilian contractor at Pearl HarborΓÇöshipyard maintenance, nothing glamorous. Today is your day off. You're thinking about church services at 10 AM, maybe a drive to Waikiki Beach afterward. The radio plays music, interrupted occasionally by news about the war in Europe and Asia. It all feels very far away.

Then you hear it. A low rumble, growing louder. Aircraft engines, lots of them. You step outside and look up. The sky is full of planesΓÇödozens, maybe hundredsΓÇöflying in tight formations toward the harbor. Your neighbor, a Navy wife, is staring too. "Training exercise?" she asks. Then you see the red circles on the wings.`,
  ...
  {
    id: "ac-scene-02",
    narrative: `0800 hours. The explosions start. Massive booms from the direction of Pearl Harbor shake your windows, rattle dishes in the cupboard. Black smoke rises in columnsΓÇöthick, oily, blotting out the morning sun. You can hear the aircraft nowΓÇöthe scream of dive bombers, the rattle of machine guns, the thunder of anti-aircraft fire starting to respond.

Your neighborhood erupts in chaos. People running, shouting, trying to understand what's happening. Car engines starting. Children crying. Someone yells "It's the Japs!" The Navy wife next door is screamingΓÇöher husband is on the Arizona. An elderly man stands in his yard, staring at the smoke, frozen.

Then you hear a different soundΓÇöa whistling, getting louder. Something is falling from the sky. Not a bomb. Something smaller, spinning, shrieking as it falls. An anti-aircraft shell, you realize. Unexploded. It's going to hitΓÇö`,
    apThemes: ["perspective", "causation"],
    apKeyConcept: "KC-7.3.I",
  ...
  {
    id: "ac-scene-03",
    narrative: `0830 hours. The shell explodes three houses down. The blast wave hits you like a physical forceΓÇöhot air, flying debris, the sound of shattering glass. When the dust clears, you see the damage. The house is partially collapsed. Smoke. Fire starting to spread. Someone is screaming inside.

All around your neighborhood, more shells are falling. American shells, fired from the ships in the harbor, from the coastal batteries, aimed at the Japanese planes overhead. But they're not exploding in the air like they're supposed to. They're falling short, hitting homes, hitting streets, hitting people. The irony is bitterΓÇöyour own military's weapons, meant to protect you, are killing civilians.
...
You can hear sirens now, but they're all heading toward Pearl Harbor and the military bases. No one is coming to help the neighborhoods. The fire in the damaged house is growing. You can still hear someone inside, calling for help. Other neighbors are emerging from their homes, dazed, bleeding, looking for direction.`,
  ...
  {
    id: "ac-scene-04",
    narrative: `0915 hours. The attack continues. More planes overheadΓÇöa second wave. More explosions from the harbor. More shells falling on civilian areas. You've lost count of how many have hit your neighborhood. The house fire is spreading despite your efforts. Three people are wounded, one seriously. The elderly man you saw earlier is deadΓÇökilled by shrapnel from an American shell.

A car screeches to a stop. A civilian defense volunteer, armband hastily tied on, shouting instructions: "Evacuate! Get away from the harbor! Head inland!" But where? How? Some people have cars, most don't. The roads are clogged. And the shells keep fallingΓÇöyou can hear them whistling down, random, unpredictable, deadly.

You see a familyΓÇömother, two small childrenΓÇöstanding in the street, paralyzed with fear. Their house has been hit. The mother is bleeding from a head wound. The children are crying. A shell explodes two blocks away. Another whistles overhead. The Japanese planes are still attacking, but it's the American shells that are killing people in your neighborhood.`,
    apThemes: ["perspective", "causation"],
    apKeyConcept: "KC-7.3.I",
  ...
  {
    id: "ac-scene-05",
    narrative: `1000 hours. The attack is over. The Japanese planes are gone, heading back to their carriers. But the danger isn't over. Fires burn across the islandΓÇöin the harbor, on the airfields, in civilian neighborhoods. Smoke darkens the sky. The anti-aircraft guns have finally stopped firing, but the damage is done.

You stand in what's left of your neighborhood. Thirty-two civilians dead in Honolulu alone. Forty-nine across Oahu. Most killed not by Japanese bombs, but by American shells that fell short. Children, elderly, familiesΓÇökilled by the weapons meant to protect them. The bitter irony will haunt you.
...
You think about this morningΓÇöthe coffee, the peaceful Sunday, the plans for church and the beach. You think about how everything changed in two hours. You think about the war that's coming, the war that's already here. And you think about what it means to be a civilian in a world at war.`,
...
// Most deaths were from AMERICAN anti-aircraft shells that fell short ΓÇö
...
const americanCivilianOutcomes = [
...

  {
    ...
    deathContext: {
      cause: "Killed by American anti-aircraft shell ΓÇö friendly fire",
      ...
      yourChoices: "You stayed in the open to help others while shells were actively falling. The longer you remained exposed, the higher your risk. An American shell ΓÇö fired to protect you ΓÇö found you instead."
    },
    epilogue: `You do not survive the attack on Pearl Harbor.

An American anti-aircraft shellΓÇöfired from the harbor defenses, meant to protect youΓÇöfalls on your neighborhood. The shell was supposed to explode in the air, destroy a Japanese plane, save lives. Instead, it falls short, hits the street where you're helping others, and detonates.
...
You made it to the harbor perimeter. The scene there was beyond descriptionΓÇöfires on the water, battleships burning, sailors in the oil slick, bombs still falling. You were trying to help when it happened. A bomb. A strafing run. A falling shell. The official record won't be specific.
...
Your supervisor at the shipyard will note your absence in the morning report. Your family will be notified by telegram. You will not receive a military citationΓÇöyou weren't military. But in the informal accounts written by survivors, your name will appear: the civilian worker who came to help when everything was on fire. Sometimes that's the only memorial there is.`
  },
...
You are one of 49 civilians who die on Oahu on December 7, 1941. Your death will be recorded as "civilian fire casualty." It won't make the front page. But your neighborΓÇöthe one you went back forΓÇöwill make sure that someone always knows what you did. Some stories are kept alive that way.`
  },

  {
    ...
    deathContext: {
      ...
      yourChoices: "You were in a high-risk zone adjacent to Pearl Harbor during an active bombardment. Sometimes there is no right choice ΓÇö only the wrong place at the wrong time."
    },
    epilogue: `You do not survive the attack on Pearl Harbor.

A shell falls on your street. American-made, fired to protect you, falling short of its target. This is how most of the 49 civilian deaths on Oahu happened that morning ΓÇö not from Japanese bombs, but from American shells raining down on the neighborhoods they were meant to defend.
...
But the records exist. December 7, 1941, 49 civilians killed on Oahu, most by friendly fire. You are one of them. Not a sailor, not a soldier. A civilian, in your own neighborhood, on a Sunday morning you thought would be ordinary.`
...

  {
    ...
    epilogue: `You survive the attack on Pearl Harbor. In the chaos and terror of that morning, you ran into burning buildings, pulled people from wreckage, saved lives while shells fell around you. Your neighborhood will remember you as a heroΓÇöthe civilian who didn't run, who didn't hide, who helped when it mattered most.
...
You'll spend the war years working at Pearl Harbor, helping rebuild the fleet. You'll watch America transform from shocked victim to determined victor. But you'll never forget December 7, 1941ΓÇöthe day you learned that in war, there are no safe places, no clear lines between combatant and civilian, no guarantees that the weapons meant to protect you won't be the ones that kill you.`
  },
...
The war that follows will transform Hawaii. Military law, curfews, blackouts, rationing. The Japanese-American communityΓÇöyour neighbors, your friendsΓÇöwill face suspicion and discrimination despite their loyalty. You'll watch the islands become an armed fortress, watch civilian life subordinated to military necessity.

But you'll also see resilience. Communities rebuilding. Civilians and military working together. The spirit of aloha surviving even in wartime. You'll work in the war effortΓÇöcivilian defense, shipyard support, whatever is needed. And you'll remember that on the worst day, when everything fell apart, ordinary people came together and helped each other survive.`
  },

  {
    ...
    epilogue: `You survive the attack on Pearl Harbor. When the attack began, you didn't think about your own safety. You thought about dutyΓÇöabout the men at the harbor who would need help, about the work that would need to be done. You made it to Pearl Harbor and spent the day pulling sailors from burning water, fighting fires, doing whatever was needed.
...
But you'll carry the weight of that day. The ships you couldn't save. The sailors who died before you could reach them. The knowledge that while you were helping at the harbor, your own neighborhood was being hit by friendly fire. War forces impossible choices. Living with those choices is its own kind of battle.`
...

  {
    ...
    survived: true,
    conditions: {},
    epilogue: `You survive the attack on Pearl Harbor. In the chaos of that morningΓÇöthe explosions, the fires, the falling shellsΓÇöyou did what you could. You helped where you were able, protected who you could protect, and somehow made it through when forty-nine other civilians on Oahu didn't.
