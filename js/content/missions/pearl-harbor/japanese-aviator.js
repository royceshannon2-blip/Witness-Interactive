...
const japaneseAviatorScenes = [
  {
    id: "ja-scene-01",
    narrative: `The carrier deck pitches beneath your boots. 0545 hours. Your Mitsubishi A6M Zero sits fueled and armed, engine cowling still warm from the pre-flight check. Around you, 182 other aircraft crowd the decks of six carriersΓÇöthe entire Kido Butai strike force.
...
Below deck, you know some men are writing letters they hope they'll never need to send. The deck officer raises his flag. Your squadron leader's engine roars to life.`,
  ...
  {
    id: "ja-scene-02",
    narrative: `0715 hours. Oahu's northern coast appears through the morning hazeΓÇögreen mountains, white beaches, peaceful. Your formation holds tight, 183 aircraft in perfect discipline. No radar warning. No interceptors rising to meet you.

The radio crackles: "All units, all unitsΓÇö" Then Fuchida's voice, calm and clear: "Tora! Tora! Tora!" Complete surprise achieved. Around you, torpedo bombers peel off toward the harbor. Dive bombers climb for altitude. Your squadronΓÇöfightersΓÇöwill suppress the airfields first.
...
Below, you can see Wheeler Field. Rows of aircraft parked wingtip to wingtip, gleaming in the sun. Perfect targets. Defenseless. Your squadron leader banks left. Your finger rests on the trigger.`,
  ...
  {
    id: "ja-scene-03",
    narrative: `0755 hours. Pearl Harbor spreads below you like a photograph from the briefing roomΓÇöBattleship Row, Ford Island, the fuel depots. Except the photograph didn't show the men. Tiny figures running on decks. Sailors in white uniforms scattering like rice grains.

A massive explosion erupts from one of the battleshipsΓÇöorange flame, black smoke mushrooming upward. The shockwave reaches you at 3,000 feet, rattling your canopy. The ship is breaking apart. You can see men jumping into water that's already burning with oil.

Your fuel gauge shows three-quarters remaining. Your ammunition counter reads full. The radio traffic is chaosΓÇötargets called, hits confirmed, damage reports. A voice cuts through: "Second wave inbound. All fighters, maintain air superiority." But you also hear: "Akagi, this is Soryu-5. Fuel critical. RequestingΓÇö" Static.`,
  ...
  {
    id: "ja-scene-04",
    narrative: `0845 hours. Anti-aircraft fire fills the sky nowΓÇöblack puffs of flak, tracer rounds arcing up like deadly fireworks. An American fighterΓÇöa P-40, you thinkΓÇöscreams past your canopy, guns blazing. Your wingman's Zero trails smoke, spiraling down toward the harbor.
...
Your fuel gauge reads half. Enough to escort him partway, maybe. Or enough to make one more pass over the harbor, finish your assigned targets. The radio crackles: "All units, all unitsΓÇöprepare for withdrawal. Rendezvous point Alpha."`,
    apThemes: ["perspective", "causation"],
    apKeyConcept: "KC-7.3.I",
  ...
  {
    id: "ja-scene-05",
    narrative: `1015 hours. The carrier Akagi rises from the horizon, flight deck waiting. Your fuel gauge needle touches red. Behind you, Pearl Harbor burnsΓÇöa column of black smoke visible for fifty miles. Eight battleships sunk or damaged. The American Pacific Fleet crippled.

But as you circle for landing, you notice what's missing from the harbor photographs now being transmitted: the American aircraft carriers. All threeΓÇöEnterprise, Lexington, SaratogaΓÇöwere at sea. Untouched. Your squadron lost four Zeros. The bomber groups lost more.
...
// Most deaths occurred during the attack run itself ΓÇö AA fire,
...
const japaneseAviatorOutcomes = [
...

  {
    ...
    deathContext: {
      cause: "Shot down over Pearl Harbor ΓÇö low fuel, no escape margin",
...
You stayed with the damaged bomber, flying slower than you should, burning fuel you couldn't afford. You watched the Kate torpedo bomber make a forced landing in the ocean ΓÇö the crew scrambled onto a life raft, alive. You circled once, confirmed they were safe, then turned north toward the carriers.

Your fuel ran out forty miles short.

You ditched in the Pacific at 1130 hours. The water was warm. You inflated your life vest, marked your position, waited. No rescue aircraft came. You are listed as missing in action ΓÇö one of 64 Japanese airmen who did not return from Pearl Harbor.
...
The flak finds you on your second attack pass over the harbor. A 1.1-inch round detonates beneath your cockpit. The Zero is a fast, maneuverable aircraft ΓÇö but it was designed without armor to save weight. There is nothing between you and the fragments.
...
Anti-aircraft fire, a midair collision, engine failure from combat damage ΓÇö the records will not be specific. You are one of 64 Japanese airmen who die in the attack on Pearl Harbor, one of 29 aircraft that do not make it back to the carriers.
...
But the carriers were at sea. The fuel depots and repair facilities survived. Within six months, at the Battle of Midway, four Japanese fleet carriers ΓÇö including some that launched your attack ΓÇö will be sunk in a single day. The war you helped start will end with Japan's unconditional surrender. You died in the opening hour of a war Japan could not win.`
  },
...

  {
    ...
    epilogue: `You return to the Akagi. Your mission was successful ΓÇö eight battleships destroyed or damaged, 188 American aircraft destroyed. But the carriers escaped. And you can't stop thinking about the sailors in the water, the burning oil, the men who never saw it coming.
...
In 1945, you will return to a Japan you barely recognize. The discipline that made you an elite pilot will help you survive the peace. You will never question whether the attack was the right decision. A soldier's duty is to serve, not to question.`
...

  {
    ...
    epilogue: `You return to the Akagi with fuel to spare. Your strategic thinking ΓÇö conserving ammunition, avoiding unnecessary risks, planning for the long flight home ΓÇö marks you as a survivor. Your squadron leader notes it in his report.
...
By 1944, you will be training new pilots ΓÇö boys, really, with barely fifty hours of flight time. You will teach them what you learned over Pearl Harbor: that tactical brilliance means nothing without strategic wisdom. That winning a battle and winning a war are not the same thing. Most of them will not survive to understand.`
...

  {
    ...
    survived: true,
    conditions: {},
    epilogue: `You return to the Akagi. The mission is complete. Pearl Harbor burns behind you, the American Pacific Fleet crippled. Around you, pilots celebrate a perfect strike ΓÇö complete surprise, devastating damage, minimal losses.
